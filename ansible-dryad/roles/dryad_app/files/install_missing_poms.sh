...
mvn install:install-file -DgroupId=postgresql -DartifactId=postgresql -Dversion=9.4-1206-jdbc41 -Dpackaging=jar -Dfile=../postgres/postgresql-9.4-1206-jdbc41.jar
